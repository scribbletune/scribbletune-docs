  ...
  return (
    <div>
      ...
      <p className="mb-6 text-lg">
        ...
        <code className="bg-gray-800 px-1 rounded">clip</code> method to create a musical phrase and the{" "}
      ...
      <p className="mb-4">This example creates a simple melody using the C major scale with a basic pattern:</p>
      <CodeBlock code={basicExample} />

      <h2 className="text-2xl font-bold mt-8 mb-4">Using Different Patterns</h2>
      <p className="mb-4">
        You can create more interesting melodies by using different patterns. In the pattern string:
      </p>
      <ul className="list-disc pl-6 mb-4 space-y-1">
        ...
        <li>
          <code className="bg-gray-800 px-1 rounded">-</code> or <code className="bg-gray-800 px-1 rounded">_</code>{" "}
          creates a rest (silence)
        </li>
      </ul>
      <p className="mb-4">Here's an example with a more complex pattern:</p>
      <CodeBlock code={patternExample} />

      <h2 className="text-2xl font-bold mt-8 mb-4">Adding Dynamics with Sizzle</h2>
      <p className="mb-4">
        The <code className="bg-gray-800 px-1 rounded">sizzle</code> parameter adds variation to the velocity of the
        notes, creating a more dynamic and expressive melody:
      </p>
      <CodeBlock code={sizzleExample} />

      <div className="mt-12 p-6 bg-gray-800/50 rounded-lg">
        <h2 className="text-xl font-bold mb-4">Next Steps</h2>
        <p className="mb-4">Now that you've learned how to create a simple melody, try:</p>
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <Link href="/examples/chord-progression" className="text-blue-400 hover:underline">
