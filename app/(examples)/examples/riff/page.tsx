...
const RiffPage = () => (
  <div>
    ...
    <p className="my-4">Scribbletune can be used to generate a commonly used pattern for riffs in trance music.</p>
    <p className="my-4">Here’s how you can create a random pattern for a riff:</p>
...
scribble.midi(clip, 'riff.mid');`} />
    <p className="my-4">To make it more interesting, you can provide more notes to the <code>randomNotes</code> parameter:</p>
