    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-300 text-lg">
          Explore practical examples to learn how to create music with
          Scribbletune. Each example includes complete code and explanations.
        </p>
      </div>
      ...
      <div className="mt-12 bg-gray-800/30 rounded-lg p-6">
        ...
        <p className="text-gray-400 mb-4">
          Have an interesting Scribbletune example to share? We'd love to
          feature it!
        </p>
        <Link
